...
const $html = "<div class='gh_button gh_exp'>Resp <b class='gh_status red'>Off</b></div><div class='gh_button gh_xost'>xOst <b class='gh_status red'>Off</b></div><div class='gh_button gh_x20'>x20 <b class='gh_status red'>Off</b></div><div class='gh_button gh_senzu'>Senzu <b class='gh_status red'>BLUE</b></div>-------------------<div class='gh_button gh_kodys'>Kody <b class='gh_status red'>Off</b></div>";
...
function updateTime() {
  ...
  if (kodyse && date.getMinutes() === 59 && (date.getSeconds() === 30 || date.getSeconds() === 40 || date.getSeconds() === 50)) {
    stop = true;
    customLog(`Próba wstrzymania skryptu (x${stopAttempts})`);
    stopAttempts++;
