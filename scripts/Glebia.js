...
var caseNumber = 0;
var wait = 3; //chodzenie
var wait2 =1; //chodzenie
var czekajpvp=120; //czeka po przejściu
var licznik=0;
var zmyl=0;
var antybot=false
var stop = true;
...
const $html = "<div class='gh_button gh_pvp'>PVP <b class='gh_status red'>Off</b></div><div class='gh_button gh_wi'>WI <b class='gh_status red'>Off</b></div>-------------------<div class='gh_button gh_kodys'>Kody <b class='gh_status red'>Off</b></div>";
...
if(stop === false && tabela99.includes(gk))
{
    ...
    GAME.emitOrder({a:39,type:24,shorts:"POWER;QslA;GODS;DESIRE;CONTRA;MMM;Legend;ODR;9uP;Mocarz;CURSED;DIVINE;Senju;9OYAL;aRED;LOST;Nakama;VD;WT;GoS;PSK;10evils;Heroes;TP;5S;DEATH;Boobs;Angels;KNIGHT;9DL;WND;10OYAL;Heroes;WeAre;8BO;CORE;Piwo;NaKacu;HsO;PWAI;Po"});
}
if(GAME.clan_wars.length < 25 && GAME.char_data.klan_id==3542 || GAME.clan_wars.length < 20 && GAME.server==1 && GAME.char_data.klan_id==25617 || GAME.clan_wars.length < 20 && GAME.server==1 && GAME.char_data.klan_id==3434){
    GAME.emitOrder({a:39,type:24,shorts:"POWER;QslA;GODS;DESIRE;CONTRA;MMM;Legend;ODR;9uP;Mocarz;CURSED;DIVINE;Senju;9OYAL;aRED;LOST;Nakama;VD;WT;GoS;PSK;10evils;Heroes;TP;5S;DEATH;Boobs;Angels;KNIGHT;9DL;WND;10OYAL;Heroes;WeAre;8BO;CORE;Piwo;NaKacu;HsO;PWAI;Po"});
}
