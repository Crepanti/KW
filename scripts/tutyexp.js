 ...
 */
const CONF_BLUE_AMOUNT = Math.floor(GAME.char_data.pr_max/400)
 ...
 */
const CONF_MIN_PA = Math.floor(GAME.char_data.pr_max/100) // 200=0.5% // 250=0.4% // 333=0.3% // 500=0.2% // 1000=0.1% // % bazowego max pa
